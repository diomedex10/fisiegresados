...
@section('main-content')
	<div class="container spark-screen">
		<div class="row">
			...
			<form action="{{url('admin/pregunta/update')}}" method="POST">
				{{csrf_field()}}
				<input type="hidden"  name="id" value="{{$dataEdit->idPreguntas}}">
				<input type="hidden"  name="idEncuestas" value="{{$dataEdit->idEncuestas}}">
